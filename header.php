                ...
                <nav class="navbar navbar-expand-lg main-nav-menu">
                    <div class="col-3 col-sm-2 site-logo">
                        <a class="main-title navbar-brand me-auto me-lg-0" href="./">
                            <img src="./assets/img/kblogo-web2.png" alt="Kerala Bank" class="at-top light-img img-fluid">
                            <img src="./assets/img/kblogo-web2.png" alt="Kerala Bank" class="at-top dark-img img-fluid d-none">
                        </a>
                    </div>
                        ...
                        <div class="col-12">
                            <ul class="nav justify-content-end align-items-center av-font-color-i av-font-i">
                                ...
                                <li class="nav-item av-font-func av-font-ii d-none d-lg-block">
                                    <button id="av-decrease-font" class="btn av-font-ii disabled av-font-color-iii text-decoration-none fw-bold" aria-current="page">A-</button>
                                    <button id="av-default-font" class="btn av-font-ii av-font-color-iii text-decoration-none fw-bold" aria-current="page">A</button>
                                    <button id="av-increase-font" class="btn av-font-ii av-font-color-iii text-decoration-none fw-bold" aria-current="page">A+</button>
                                </li>
                                <li class="nav-item">
                                            ...
                                            <li class="dropdown-item py-3">
                                                <a href="" class="text-decoration-none unread-notification av-font-i d-flex text-wrap">
                                                    <svg width="54" height="25" viewBox="0 0 30 25" class="align-self-center" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g class="nav-toggle">
                                                            <path d="M7.91791 4.0186C7.91791 1.85187 6.16426 0.0904236 3.98778 0.0904236C1.81909 0.0904236 0.0693359 1.85381 0.0693359 4.0186C0.0693359 6.17949 1.82104 7.94289 3.98778 7.94289C6.16426 7.94289 7.91791 6.17949 7.91791 4.0186Z" fill="#CB3F3F"/>
                                                            <path d="M0.118164 14.151C0.118164 15.6942 1.36326 16.9374 2.90258 16.9374C4.44189 16.9374 5.69478 15.6942 5.69478 14.151C5.69673 12.6058 4.44384 11.3549 2.90258 11.3549C1.36326 11.3549 0.118164 12.6039 0.118164 14.151Z" fill="#CB3F3F"/>
                                                            <path d="M14.8823 0.14679C12.7175 0.14679 10.958 1.90824 10.958 4.07497C10.958 6.24756 12.7175 7.99926 14.8823 7.99926C17.0529 7.99926 18.8105 6.24561 18.8105 4.07497C18.8105 1.90824 17.0529 0.14679 14.8823 0.14679Z" fill="#CB3F3F"/>
                                                            <path d="M10.9036 11.3568C9.35839 11.3568 8.11914 12.6058 8.11914 14.1529C8.11914 15.6961 9.35839 16.9392 10.9036 16.9392C12.4507 16.9392 13.6919 15.6961 13.6919 14.1529C13.6919 12.6058 12.4507 11.3568 10.9036 11.3568Z" fill="#CB3F3F"/>
                                                            <path d="M21.8193 4.07497C21.8193 6.24756 23.5808 7.99926 25.7436 7.99926C27.9182 7.99926 29.6757 6.24561 29.6757 4.07497C29.6738 1.90824 27.9182 0.14679 25.7436 0.14679C23.5808 0.14679 21.8193 1.90824 21.8193 4.07497Z" fill="#CB3F3F"/>
                                                            <path d="M18.9035 11.3568C17.3642 11.3568 16.1055 12.6058 16.1055 14.1529C16.1055 15.6961 17.3642 16.9392 18.9035 16.9392C20.4467 16.9392 21.6977 15.6961 21.6977 14.1529C21.6977 12.6058 20.4487 11.3568 18.9035 11.3568Z" fill="#CB3F3F"/>
                                                            <path d="M24.0938 14.151C24.0938 15.6942 25.3408 16.9374 26.8782 16.9374C28.4253 16.9374 29.6762 15.6942 29.6762 14.151C29.6762 12.6058 28.4253 11.3549 26.8782 11.3549C25.3408 11.3549 24.0938 12.6039 24.0938 14.151Z" fill="#CB3F3F"/>
                                                            <path d="M0 22.364C0 23.7747 1.14377 24.9048 2.5428 24.9048C3.94572 24.9048 5.07975 23.7747 5.07975 22.364C5.07975 20.9649 3.94572 19.8231 2.5428 19.8231C1.14377 19.8231 0 20.9649 0 22.364Z" fill="#CB3F3F"/>
                                                            <path d="M8.1377 22.364C8.1377 23.7747 9.27173 24.9048 10.6805 24.9048C12.0717 24.9048 13.2116 23.7747 13.2116 22.364C13.2135 20.9649 12.0717 19.8231 10.6805 19.8231C9.27367 19.8231 8.1377 20.9649 8.1377 22.364Z" fill="#CB3F3F"/>
                                                            <path d="M16.2764 22.364C16.2764 23.7747 17.4201 24.9048 18.8075 24.9048C20.2123 24.9048 21.3522 23.7747 21.3522 22.364C21.3522 20.9649 20.2123 19.8231 18.8075 19.8231C17.4182 19.8231 16.2764 20.9649 16.2764 22.364Z" fill="#CB3F3F"/>
                                                            <path d="M24.4043 22.364C24.4043 23.7747 25.5383 24.9048 26.9413 24.9048C28.3461 24.9048 29.4724 23.7747 29.4724 22.364C29.4724 20.9649 28.3461 19.8231 26.9413 19.8231C25.5383 19.8231 24.4043 20.9649 24.4043 22.364Z" fill="#CB3F3F"/>
                                                        </g>
                                                    </svg>
                        ...
                        <div class="col-12 mt-3 mob-nav d-flex align-items-center justify-content-end d-lg-none">
                            ...
                            <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#av-mob-main-nav" aria-controls="av-mob-main-nav">
                                <svg width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g class="nav-toggle">
                                        <path d="M7.91791 4.0186C7.91791 1.85187 6.16426 0.0904236 3.98778 0.0904236C1.81909 0.0904236 0.0693359 1.85381 0.0693359 4.0186C0.0693359 6.17949 1.82104 7.94289 3.98778 7.94289C6.16426 7.94289 7.91791 6.17949 7.91791 4.0186Z" fill="#FFFFFF"/>
                                        <path d="M0.118164 14.151C0.118164 15.6942 1.36326 16.9374 2.90258 16.9374C4.44189 16.9374 5.69478 15.6942 5.69478 14.151C5.69673 12.6058 4.44384 11.3549 2.90258 11.3549C1.36326 11.3549 0.118164 12.6039 0.118164 14.151Z" fill="#FFFFFF"/>
                                        <path d="M14.8823 0.14679C12.7175 0.14679 10.958 1.90824 10.958 4.07497C10.958 6.24756 12.7175 7.99926 14.8823 7.99926C17.0529 7.99926 18.8105 6.24561 18.8105 4.07497C18.8105 1.90824 17.0529 0.14679 14.8823 0.14679Z" fill="#FFFFFF"/>
                                        <path d="M10.9036 11.3568C9.35839 11.3568 8.11914 12.6058 8.11914 14.1529C8.11914 15.6961 9.35839 16.9392 10.9036 16.9392C12.4507 16.9392 13.6919 15.6961 13.6919 14.1529C13.6919 12.6058 12.4507 11.3568 10.9036 11.3568Z" fill="#FFFFFF"/>
                                        <path d="M21.8193 4.07497C21.8193 6.24756 23.5808 7.99926 25.7436 7.99926C27.9182 7.99926 29.6757 6.24561 29.6757 4.07497C29.6738 1.90824 27.9182 0.14679 25.7436 0.14679C23.5808 0.14679 21.8193 1.90824 21.8193 4.07497Z" fill="#FFFFFF"/>
                                        <path d="M18.9035 11.3568C17.3642 11.3568 16.1055 12.6058 16.1055 14.1529C16.1055 15.6961 17.3642 16.9392 18.9035 16.9392C20.4467 16.9392 21.6977 15.6961 21.6977 14.1529C21.6977 12.6058 20.4487 11.3568 18.9035 11.3568Z" fill="#FFFFFF"/>
                                        <path d="M24.0938 14.151C24.0938 15.6942 25.3408 16.9374 26.8782 16.9374C28.4253 16.9374 29.6762 15.6942 29.6762 14.151C29.6762 12.6058 28.4253 11.3549 26.8782 11.3549C25.3408 11.3549 24.0938 12.6039 24.0938 14.151Z" fill="#FFFFFF"/>
                                        <path d="M0 22.364C0 23.7747 1.14377 24.9048 2.5428 24.9048C3.94572 24.9048 5.07975 23.7747 5.07975 22.364C5.07975 20.9649 3.94572 19.8231 2.5428 19.8231C1.14377 19.8231 0 20.9649 0 22.364Z" fill="#FFFFFF"/>
                                        <path d="M8.1377 22.364C8.1377 23.7747 9.27173 24.9048 10.6805 24.9048C12.0717 24.9048 13.2116 23.7747 13.2116 22.364C13.2135 20.9649 12.0717 19.8231 10.6805 19.8231C9.27367 19.8231 8.1377 20.9649 8.1377 22.364Z" fill="#FFFFFF"/>
                                        <path d="M16.2764 22.364C16.2764 23.7747 17.4201 24.9048 18.8075 24.9048C20.2123 24.9048 21.3522 23.7747 21.3522 22.364C21.3522 20.9649 20.2123 19.8231 18.8075 19.8231C17.4182 19.8231 16.2764 20.9649 16.2764 22.364Z" fill="#FFFFFF"/>
                                        <path d="M24.4043 22.364C24.4043 23.7747 25.5383 24.9048 26.9413 24.9048C28.3461 24.9048 29.4724 23.7747 29.4724 22.364C29.4724 20.9649 28.3461 19.8231 26.9413 19.8231C25.5383 19.8231 24.4043 20.9649 24.4043 22.364Z" fill="#FFFFFF"/>
                                    </g>
                                </svg>
                            </button>
